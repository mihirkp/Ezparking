...
if(isset($_REQUEST['login']))
{
	...
	if(isset($rm))
	{
	setcookie('cname',$cname,time()+15000);
	...
	$sel="select * from client_reg where cname='$cname' and password='$password'";
	$exe=$conn->query($sel);
	$chk=$exe->num_rows;
	if($chk==1)
	{
...
<section class="contact-w3ls">
	<div class="container">
		<h3 class="agile-title">Client Login Page</h3>
				...
				<form action="#" method="post">
					<div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="cname" id="name" Placeholder="Enter name" value="<?php if(isset($_COOKIE['cname']))
									{
										echo $_COOKIE['cname'];
