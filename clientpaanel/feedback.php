...
if(isset($_REQUEST['submit']))
    ...
    $ins="insert into feedback(name,gfeedback) values('$name','$gfeedback')";
    $exe=$conn->query($ins);
    if($exe)
    {
        echo "insert success";
		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active" ><a href="services.html">About</a></li>
					<li><a class="" href="gallery.html">Rent driveway</a></li>
					<li><a class="" href="gallery.html">Help</a></li>
				...
				<form action="#" method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="gfeedback" id="gfeedback" Placeholder="Enter password" required="">
                            <p class="help-block"></p>
                        </div>
                    </div>
