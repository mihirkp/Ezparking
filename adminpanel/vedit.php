...
if(isset($_REQUEST['evendorid']))
{
    $evendorid=$_REQUEST['evendorid'];
    $sel="select * from vendor where vendorid='$evendorid'";
    $exe=$conn->query($sel);
...
if(isset($_REQUEST['update']))
{
    ...
    $upd="update vendor set vendorname='$vendorname',vpassword='$vpassword',vemail='$vemail',vphone='$vphone',vaddress='$vaddress' where vendorid='$evendorid'";
    $exe=$conn->query($upd);
    if($upd)
    {
                ...
                <form action="#" method="post" name="myform" id="myform">
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="vendorname" id="name" value="<?php echo $fetch->vendorname; ?>" Placeholder="Enter name" data-bValidator="required,alpha"Data>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="vpassword" id="name" value="<?php echo $fetch->vpassword; ?>" Placeholder="Enter password" data-bValidator="required,maxlength[8],minlength[3]"Data>
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="email" class="form-control" name="vemail" id="email" value="<?php echo $fetch->vemail; ?>" Placeholder="Enter E-mail Address" data-bValidator="required,email"Data >
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="tel" class="form-control" name="vphone" id="phone" value="<?php echo $fetch->vphone; ?>" Placeholder="Enter Mobile Number" data-bValidator="required,number"Data >
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="vaddress" id="name" value="<?php echo $fetch->vaddress; ?>" Placeholder="Enter vendor address" >
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div id="success"></div>
