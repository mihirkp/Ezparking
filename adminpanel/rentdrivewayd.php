		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav navbar-right">
				<!-- Hidden li included to remove active class from about link when scrolled up past about section -->
					...
					<li><a class="active" href="rentdrivewayd.php">client Request</a></li>
...
<div class="bs-docs-example">
				<table id="table_id" class="display" class="table table-striped">
					...
					<tbody>
						<?php
							$sel="select * from rentspace";
							$exe=$conn->query($sel);
							while($fetch=$exe->fetch_object())
							{
						?>
						<tr>
							<td><?php echo $fetch->reid; ?></td>
							<td><?php echo $fetch->rname; ?></td>
							
							<td><?php echo $fetch->phone; ?></td>
							<td><?php echo $fetch->email; ?></td>
							<td><?php echo $fetch->space; ?></td>
						</tr>
						<?php
						}
						?>	
