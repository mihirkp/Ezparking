				...
				<form action="#" method="post" enctype="multipart/form-data">
					<div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="name" id="name" Placeholder="Enter name" value="<?php if(isset($_COOKIE['name']))
							{
							echo $_COOKIE['name'];
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                    	<h5>Don't have an account?   <a class="" href="regform.php">Sign up→</a></h5>
                    <p class="help-block"></p>
                        </div>
                    </div>
                    ...
                    <div><a href="https://accounts.google.com/o/oauth2/auth?response_type=code&amp;redirect_uri=http%3A%2F%2Flocalhost%2FEzparking%2Fgoogle_login_api_HRWNdR%2F&amp;client_id=194087158307-ct2327llkdiuv7o2bqftldr88vefl9t5.apps.googleusercontent.com&amp;scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.profile+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email&amp;access_type=offline&amp;approval_prompt=force"><img src="images/glogin.png" alt=""></a></div>
