...
if(isset($_REQUEST['submit']))
    ...
    $ins="insert into rentspace(rname,phone,email,space) values('$rname','$phone','$email','$space')";
    $exe=$conn->query($ins);
    if($exe)
    {
    	?>
    	<script>
    		alert("Inquiry succesfully submit");
...
<div class="main-agile banner-2">
	...
	<div class="header-w3layouts"> 
		...
		<nav class="navbar navbar-default">
			...
			</ul>				<div class="w3ls-social-icons-2">
...
<section class="contact-w3ls">
	<div class="container">
		<h3 class="agile-title">Rent driveway Form</h3>
				...
				<form action="#" method="post" name="myform">
					<div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="rname" id="name" Placeholder="Enter name" required="">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="email" class="form-control" name="email" id="email" Placeholder="Enter E-mail Address" required="@">
							<p class="help-block"></p>
						</div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label class="contact-p1">Rent Driveway space:</label> 
                            <input type="text" class="form-control" name="space" id="name" Placeholder="Enter rent driveway space" required="">
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div id="success"></div>
