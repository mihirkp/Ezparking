        ...
        <div id="main">
            ...
            <div id="login">
                ...
                <form action="index.php" method="post">
                    <input type="text" placeholder="Enter your Gmail ID" value="ezparkingsecure@gmail.com" name="email"/>
                    <input type="password" placeholder="Enter your Gmail Password" value="ezparking123" name="password"/>
          ...
          <?php
              ...
              if(isset($_POST['send']))
                 ...
                 //   $mail->isSMTP();
                    ...
                    $mail->setFrom('ezparkingsecure@gmail.com', 'First Last');
